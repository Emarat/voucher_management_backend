...
router.get('/accounts/:id', async (req, res) => {
  try {
    ...
    const query =
      'SELECT accounts.*, account_type.account_type_name, account_detail_type.account_detail_name FROM accounts JOIN account_type ON accounts.account_type_id = account_type.account_type_id JOIN account_detail_type ON accounts.account_details_type_id = account_detail_type.account_detail_type_id WHERE account_id = $1';
